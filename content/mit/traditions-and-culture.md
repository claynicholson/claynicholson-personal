---
title: Traditions, Hacks, and Culture
category: culture
summary: Hacks, the Brass Rat, Mystery Hunt, MIThenge, and the annual rhythm of MIT traditions.
sources:
  - https://hacks.mit.edu
...
## Hacks
MIT's signature tradition: elaborate, harmless, anonymous pranks. Canon includes the **campus police car on the Great Dome** (1994), the Dome becoming R2-D2, the Wright Flyer for the flight centennial, the CalTech cannon heist (2006), and the **Great Droid** era. The Dome regularly gets decorated for events. **hacks.mit.edu** and the MIT Museum archive them. Informal hacker ethics: be safe, cause no damage, leave instructions for removal, don't hack for profit.
...
- **IHTFP** — the love-hate motto (see the lingo topic).
- **The Smoot** — the Harvard Bridge's official unit (364.4 Smoots + 1 ear); Google Earth supports it.
- **MIT Museum** (Kendall) — hack artifacts, Kismet the robot, holography; free for students.
- **East vs. West campus** identity, **firehose** metaphors, an institutional soft spot for Rube Goldberg machines, and a genuine, campus-wide belief that building things is the highest form of fun.
- **Nerd pride**: the phrase "the geeks shall inherit the earth" is lived doctrine; nobody here thinks you're weird for caring intensely about something obscure. That might be the actual tradition.

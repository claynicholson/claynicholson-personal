...
category: support
summary: The ISO, visas, work rules (CPT/OPT), taxes, and resources specific to international students.
sources:
  - https://iso.mit.edu
...
- Getting started stateside: SSN (needed once you have a paid job — ISO guides this), bank accounts (banks near Kendall/Central are used to MIT internationals), phone plans, winter clothes (seriously).
- No car needed; see the transportation topic.

## Community
- **iREFS** (international peer support for grads), country/cultural clubs (dozens, from ASA listings), **International Students Association**, holiday host programs, and the ISO's orientation events.
- English resources: ELS (English Language Studies) subjects for academic writing/speaking.
